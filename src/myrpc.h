...
struct RespProcessInfo {
    ::google::protobuf::Message* _resp_msg;
    const boost::shared_ptr<boost::asio::ip::tcp::socket>& _sock;
    RespProcessInfo(::google::protobuf::Message* resp_msg, const boost::shared_ptr<boost::asio::ip::tcp::socket>& sock): _resp_msg(resp_msg), _sock(sock){}
};
...
void MyServer::dispatch_msg(
    ...
    RespProcessInfo process_info(resp_msg, sock);
...
void MyServer::on_resp_msg_filled(
    ...
    boost::scoped_ptr<::google::protobuf::Message> resp_msg_guard(process_info._resp_msg);

    std::string resp_str;
    pack_message(process_info._resp_msg, &resp_str);

    process_info._sock->send(boost::asio::buffer(resp_str));
}
